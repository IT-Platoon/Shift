...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('graphic', models.JSONField(verbose_name='Model response')),
                ('model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='graphics', to='projects.modelprocess', verbose_name='Model, that computing this request')),
            ],
            options={
                'verbose_name': 'График',
